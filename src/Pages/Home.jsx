...
const WORDS = ["Passionate Programmer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/KartikLakhotiya" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/kartik-lakhotiya-383a0319a/" },
  { icon: Instagram, link: "https://www.instagram.com/kartik.lakhotiya" }
];
        ...
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6 xl:ml-40 md:ml-20">
                <StatusBadge />
                <MainTitle />
